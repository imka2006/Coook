              ...
              <div class="swiper">
                  <div class="swiper-wrapper">
                      <div class="swiper-slide">
                          <h3
                              class="catalog__food--subtitle"
                          >
                          ${data[i].name}
                          </h3>
                          <div
                              class="catalog__food--data"
                          >
                              <span
                                  class="catalog__food--gram"
                                  >${data[i].gram} г</span
                          ...
                          <p
                              class="catalog__food--descr"
                          >
                          ${data[i].coment}
                          </p>

                          <h3
                              class="catalog__additionally--title"
                          >
                              Дополнительно:
                          </h3>
                          <div
                              class="catalog__additionally--block row"
                          >
                              <span
                                  class="catalog__additionally--info"
                                  > ${data[i].descr}/span
                              >
                              <div
                                  class="catalog__additionally--content"
                              >
                                  <span
                                      class="catalog__additionally--price"
                                      >+ 20₽</span
                                  >
                                  <input
                                      class="catalog__additionally--checkbox"
                                      type="checkbox"
                                  />
                              </div>
                          </div>
